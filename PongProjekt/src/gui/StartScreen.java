	...
	public StartScreen() {
		...
		btnStory.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				/*
				 * GameLogic.setSpiel(0); GameLogic.setCounter(0); GameLogic spiellogik = new
				 * GameLogic(); //Pong wird ausgeführt new Classic(spiellogik); //Frame wird
				 * erstellt zum Pong Startclose(); //StartScreen Schließen -> soll Nach Gewinnen
				 * oder Verlieren der Runde/Level als Abfrage wieder Erstellt werden
		...
		btnEndless.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Startclose(); // StartScreen Schließen -> soll Nach Verlieren der Runde als Abfrage wieder
								// Erstellt werden
				BeweglichesRechteck.setGegenerPunkte(0);
				BeweglichesRechteck.setSpielerPunkte(0);
		...
		btnVerlassen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				option = JOptionPane.showConfirmDialog(null, "Bist du dir sicher, das Spiel zu beenden?", "Beenden",
		...
		gl_pStartScreen.setHorizontalGroup(gl_pStartScreen.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pStartScreen.createSequentialGroup().addContainerGap().addGroup(gl_pStartScreen
						...
						.addGroup(gl_pStartScreen.createSequentialGroup()
								...
								.addGap(18)
								.addComponent(lbStartScreenTitel, GroupLayout.PREFERRED_SIZE, 478,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(lblSettings, GroupLayout.PREFERRED_SIZE, 52, Short.MAX_VALUE)
								.addContainerGap())
						.addGroup(gl_pStartScreen.createSequentialGroup()
								.addComponent(btnStory, GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE).addGap(392))
						.addGroup(gl_pStartScreen.createSequentialGroup()
								.addComponent(btnClassic, GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE).addGap(453))
						.addGroup(gl_pStartScreen.createSequentialGroup()
								.addComponent(btnEndless, GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE).addGap(453))
						.addGroup(gl_pStartScreen.createSequentialGroup()
		...
		gl_pStartScreen.setVerticalGroup(gl_pStartScreen.createParallelGroup(Alignment.LEADING).addGroup(gl_pStartScreen
				...
				.addGroup(gl_pStartScreen.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pStartScreen.createParallelGroup(Alignment.BASELINE)
								.addComponent(lbStartScreenTitel, GroupLayout.PREFERRED_SIZE, 36,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblSettings))
						.addComponent(lblShop))
				.addPreferredGap(ComponentPlacement.RELATED, 135, Short.MAX_VALUE).addComponent(btnStory)
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnClassic)
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnEndless)
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnMultiplayer).addGap(18)
				.addComponent(btnVerlassen, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE).addGap(79)));
