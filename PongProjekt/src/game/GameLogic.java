...
public class GameLogic {
	...
	public GameLogic() {
		...
		// Objekte im Spiel:
		BeweglichesRechteck beispielObjekt1 = new BeweglichesRechteck(50, 100, 20, 20);				//Rechteck wird Erstellt
		spielObjekte.add(beispielObjekt1);
		beispielObjekt1.richtung = 0; // Startrichtung
		BeweglichesRechteck beispielObjekt2 = new BeweglichesRechteck(300, 400, 20, 20);			//Rechteck wird Erstellt
